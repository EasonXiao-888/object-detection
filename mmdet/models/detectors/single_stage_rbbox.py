...
class SingleStageDetectorRbbox(BaseDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(SingleStageDetectorRbbox, self).__init__(init_cfg)
        if pretrained:
    ...
    def forward_train(self,
        ...
        """
        super(SingleStageDetectorRbbox, self).forward_train(img, img_metas)
        x = self.extract_feat(img)
    ...
    def simple_test(self, img, img_metas, rescale=False):
        ...
        bbox_results = [
            dbbox2result(det_bboxes, det_labels, self.bbox_head.num_classes)
