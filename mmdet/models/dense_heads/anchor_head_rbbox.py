...
from mmdet.core.bbox import (
                        delta2dbbox, delta2dbbox_v3 , dbbox2delta ,dbbox2delta_v3
                        )
from mmdet.core import multi_apply
from mmdet.core.post_processing import multiclass_nms_rbbox
from mmdet.core.anchor import anchor_target_rbbox
from mmdet.core.bbox.transforms_rbbox import gt_mask_bp_obbs, hbb2obb_v2
...
class AnchorHeadRbbox(nn.Module):
    ...
    def __init__(self,
        ...
        super(AnchorHeadRbbox, self).__init__(init_cfg)
    ...
    def _get_targets_single(self,
        ...
        gt_obbs = gt_mask_bp_obbs(gt_masks, True)
    ...
    def _get_bboxes(self,
        ...
        for cls_score, bbox_pred, anchors in zip(mlvl_cls_scores,
            ...
            bboxes = hbb2obb_v2(anchors)
            if self.with_module:
                bboxes = delta2dbbox(bbox, bbox_pred, self.target_means,
                                     self.target_stds, img_shapes)
            else:
                bboxes = delta2dbbox_v3(bbox, bbox_pred, self.target_means,
                                     self.target_stds, img_shapes)
        ...
        if with_nms:
            ...
            for (mlvl_bboxes, mlvl_scores) in zip(batch_mlvl_bboxes,
                                                  batch_mlvl_scores):
                det_bbox, det_label = multiclass_nms_rbbox(mlvl_bboxes, mlvl_scores,
